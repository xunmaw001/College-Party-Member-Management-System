		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">支部日志管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">支部日志管理</li>
								<li class="breadcrumb-item active">支部日志列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">支部日志列表</h3>							
												...
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('zhanghao')">账号<i id="zhanghaoIcon" class="fa fa-sort"></i></th>
																																																			...
																																																			<th onclick="sort('rizhi')">日志<i id="rizhiIcon" class="fa fa-sort"></i></th>
	...
	<script>
			...
			row.appendChild(checkbox)
							...
							var zhanghaoCell  = document.createElement('td');
									...
									row.appendChild(dangzhibuCell);
				            				var rizhiCell  = document.createElement('td');

												 rizhiCell.innerHTML = item.rizhi;

				
									row.appendChild(rizhiCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("zhiburizhi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"zhiburizhi");
