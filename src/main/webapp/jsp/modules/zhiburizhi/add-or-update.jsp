		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑支部日志</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">编辑支部日志</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">支部日志信息</h3>
								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										...
										<input id="dangzhibu" name="dangzhibu" class="form-control" placeholder="党支部">
											...
											<div class="form-group col-md-6">
										<label>日志</label>
										<input id="rizhi" name="rizhi" class="form-control" placeholder="日志">
									</div>
											<div class="form-group col-md-6">
										<label>类型</label>
										...
										<div id="riqiDate" class="input-append date form_datetime">
											<input id="riqi-input" name="riqi" size="20" type="text" readonly>
	...
	<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resources/js/datetimepicker/bootstrap-datetimepicker.min.js"></script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "zhiburizhi/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("zhiburizhi/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("zhiburizhi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
				...
				http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												...
												if(res.data != null && res.data != '' && res.data.rizhi != null && res.data.rizhi != ''){

															$("#rizhi").val(res.data.rizhi);
													}
