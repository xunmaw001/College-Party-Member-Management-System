		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">党费登记管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">党费登记管理</li>
								<li class="breadcrumb-item active">党费登记列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">党费登记列表</h3>							
												...
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('zhanghao')">账号<i id="zhanghaoIcon" class="fa fa-sort"></i></th>
																																																			...
																																																			<th onclick="sort('jiaonajine')">缴纳金额<i id="jiaonajineIcon" class="fa fa-sort"></i></th>
	...
	<script>
			...
			row.appendChild(checkbox)
							...
							var zhanghaoCell  = document.createElement('td');
									...
									row.appendChild(suozaizhibuCell);
				            				var jiaonajineCell  = document.createElement('td');

												 jiaonajineCell.innerHTML = item.jiaonajine;

				
									row.appendChild(jiaonajineCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("dangfeidengji/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function getSum(colName){
			http("dangfeidengji"+colName,"GET",{
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"dangfeidengji");
        ...
        function pay(id){
			...
			window.sessionStorage.setItem('tableName',"dangfeidengji");
