		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑党费登记</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">编辑党费登记</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">党费登记信息</h3>
								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										...
										<input id="suozaizhibu" name="suozaizhibu" class="form-control"  value="" readonly>
											...
											<div class="form-group col-md-6">
										<label>缴纳金额</label>
										<input id="jiaonajine" name="jiaonajine" class="form-control" placeholder="缴纳金额">
									</div>
											<div class="form-group col-md-6">
										<label>登记日期</label>
	...
	<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resources/js/datetimepicker/bootstrap-datetimepicker.min.js"></script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "dangfeidengji/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("dangfeidengji/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("dangfeidengji/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			$("#updateId").val(ruleForm.id);	
																...
																$("#jiaonajine").val(ruleForm.jiaonajine);	
				...
				http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												...
												if(res.data != null && res.data != '' && res.data.jiaonajine != null && res.data.jiaonajine != ''){

															$("#jiaonajine").val(res.data.jiaonajine);
													}
