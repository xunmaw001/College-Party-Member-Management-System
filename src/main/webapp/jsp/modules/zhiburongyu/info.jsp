...
<body>
								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
																					...
																					<div class="form-group col-md-6">
																								...
																								<input id="chengguo" name="chengguo" class="form-control" v-model="ruleForm.chengguo" readonly>
																							</div>
	...
	<script>
		...
		function setContent(){
					...
					var mes = '' + ruleForm.rongyu;
					var rongyuUeditor = UE.getEditor('rongyuEditor');
					rongyuUeditor.ready(function() {
						rongyuUeditor.setContent(mes);
						rongyuUeditor.setDisabled('fullscreen');
					});
				}
								}  
